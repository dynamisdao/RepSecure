...
module.exports = function(grunt) {
		...
		jade: {
			build: {
				...
				files: [
					...
					{
						'dist/token2.html': 'views/token2.jade'
					},
					{
	...
	grunt.registerTask('default', ['clean', 'jade', 'copy', 'concat:vendor', 'concat:scripts', 'concat:frontier', 'concat:css', 'clean:cleanup_js', 'clean:cleanup_css']);
